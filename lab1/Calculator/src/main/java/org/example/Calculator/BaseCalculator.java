...
public abstract class BaseCalculator implements Calculator {
    ...
    @Override
    public String calculate(String operation, String base, String num1, String num2) {
        int result = simpleCalculation(convertNumbersToDecimal(num1, num2), operation);
        return convertResultToBase(result);
    }

    protected abstract int[] convertNumbersToDecimal(String num1, String num2);
    ...
    protected abstract String convertResultToBase(int result);
}
